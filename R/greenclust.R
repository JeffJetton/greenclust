...
#'   \code{\link{rect.hclust}()}. The height vector, in this case, represents
#'   the reduction in r-squared seen at each clustering step. The greenclust
#'   object also includes a vector for the chi-squared test p-value at each
#'   step and a boolean vector indicating whether the step had a tie for
#'   "winner".
